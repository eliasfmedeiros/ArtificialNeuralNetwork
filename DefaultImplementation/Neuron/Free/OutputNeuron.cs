...
public abstract class OutputNeuron : FreeNN.InputDescribedNeuron {
	...
	public OutputNeuron(IInputComponentIdentity[] input, Random? weightStarter = null) {
	...
	#region subclasses
	public sealed class CustomActivated(IInputComponentIdentity[] input, IActivation activation, Random? weightStarter = null) : OutputNeuron(input, weightStarter) {
		public override IActivation GetActivation() => activation;
	}

	public sealed class ReLUActivated(IInputComponentIdentity[] input, Random? weightStarter = null) : OutputNeuron(input, weightStarter) {
		public override IActivation GetActivation() => Function.ReLU.Shared;
	}

	public sealed class SigmoidActivated(IInputComponentIdentity[] input, Random? weightStarter = null) : OutputNeuron(input, weightStarter) {
		public override IActivation GetActivation() => Function.Sigmoid.Shared;
	}

	public sealed class TanhActivated(IInputComponentIdentity[] input, Random? weightStarter = null) : OutputNeuron(input, weightStarter) {
